...
export const APP_NAVIGATION: NavDef[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Offered", href: "/applications?stage=offered" },
      { label: "Hired", href: "/applications?stage=hired" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Active Pipeline", href: "/candidates?tab=active" },
      { label: "Talent Pool", href: "/candidates?tab=talent-pool" },
      { label: "Archived", href: "/candidates?tab=archived" },
  ...
  },
  {
    ...
    children: [
      { label: "Message Center", href: "/communications" },
      { label: "Email Templates", href: "/communications?tab=templates" },
      { label: "Audit History", href: "/communications?tab=history" },
    ],
  },
  {
    label: "Reports",
